...
const basicColors = {
  ...
  "--header-background":
    'url("../img/headerbackgroundcircles.svg"), linear-gradient(rgba(121, 157, 171, 1), rgba(239, 239, 241, 1), rgba(239, 239, 241, 1))',
  "--text-color": "#3C3C43",
  "--white": "#FFFFFF",
  "--black": "#000000",
};
...
const darkmodeColors = {
  ...
  "--header-background":
    'linear-gradient(rgba(121, 157, 171, 0.5), rgba(28, 28, 28, 1), rgba(28, 28, 28, 1)), url("../img/headerbackgroundcircles.svg")',
  "--text-color": "#FFFFFF",
  "--white": "#000000",
  "--black": "#FFFFFF",
};
